...
def display_data_as_output(filtered_data):
    print(
        f"S.N  {'Host_Response_Rate':<20} {'Host_Identity_Verified':<24} {'Host_Total_Listings_Count':<27} {'Unique_City_ID':<16} {'Location_Verified ':<19} {'Property_Type':<14} {'Room_Type':<12} {'Max_Accomodation ':<16} {'Bathrooms_Count ':<14} {'Bedrooms_Count ':<14} {'Beds_Count':<14} {'Bed_Type':<14} {'Amenities_Price ':<18} {'Price':<11} {'Minimum_Nights':<17} {'Number_of_Reviews':<18} {'Review_Scores_Rating':<24} {'Instant_Bookable':<18} {'Cancellation_Rate':<19} {'Reviews_per_Month':<19} {'Fraud_Count':<19}  ")
